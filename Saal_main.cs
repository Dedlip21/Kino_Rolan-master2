...
using Kinoteatr_bilet;

namespace Kino_Rolan
{
    public partial class Saal_main : Form
    {
        ...
        public Saal_main(int read, int kohad)
        {
        ...
        {
            pocta = Interaction.InputBox("Valita sinu email", "Email");
            ...
            if (pocta != "")
            {
                ...
                string text = "Kinoteatr: „Kinoworld“\nFilmi on: " + filmivaata;
